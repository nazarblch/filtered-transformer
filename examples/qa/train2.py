...
from examples.qa.modules import DataFilter, MemUpMemoryImpl, MemUpMemoryRMT, Predictor, RobertaRT
...
roberta.train()
rmt = RecurrentTransformerWithStateEmbedding(roberta, 10, tokenizer).cuda()
predictor = Predictor(roberta.config).cuda()

weights = torch.load("/home/jovyan/qa_5.30.pt", map_location="cpu")
rmt.load_state_dict(weights["mem"])
...
writer = SummaryWriter("/home/jovyan/pomoika/qa/4.2")
global_step = 0
batch_count = 0
...
for it in range(100):
    ...
    for batch in train_dataloader:
        ...
        state = rmt.init_state(labels.shape[0] * 4)
        done = False
        info = {}
        ...
        if batch_count % 30 == 0:
            ...
            }, f"/home/jovyan/qa_5.{batch_count}.pt")
